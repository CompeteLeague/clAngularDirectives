 ...
 * 
 * Version: 1.0.0 - 2016-02-15T19:54:24.702Z
 * License: MIT
 */


angular.module("cl.thumbnail").run(["$templateCache", function($templateCache) {$templateCache.put("clFeedback.html","<div class=\"cl-feedback alert\" ng-class=\"newMsg.class\" ng-show=\"showMsg\">{{newMsg.msg}}</div>");}]);
(function () { 
"use strict";
